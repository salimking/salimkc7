...
def appoint(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            subject, from_email, to = 'Appointment for you', 'saimkc7@gmail.com', EmailId
...
def register(request):
    if request.method == 'POST':
        ...
        try:
            ...
            cursor.execute('INSERT INTO app_users (password, email, firstname, lastname,address,phone) VALUES (?, ?, ?, ?,?,?)',
                           (hashlib.md5(password.encode()).hexdigest(), email, firstName, lastName,address,phone))
            db.commit()
        except:
            db.rollback()
            db.close()
...
def clearcart(request):
    ...
    if noOfItems == 0:
        ...
        subject, from_email, to = 'Product Confirm', 'salimkc7@gmail.com', email
        text_content = 'This is an important message.'
